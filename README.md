...
**Quantitative Finance | Risk Management | AI Engineering**

I build hands-on analytics tools at the intersection of **quantitative risk, treasury/markets, and applied AI** — from regulatory liquidity dashboards to multi-agent LLM trading systems.

🔗 **Portfolio site:** [nmadagi.github.io/portfolio](https://nmadagi.github.io/portfolio) · **LinkedIn:** [linkedin.com/in/nitinmadagi](https://www.linkedin.com/in/nitinmadagi/)
...
| [Credit Risk Strategy](https://github.com/nmadagi/credit_risk_strategy) | PD modeling (logistic regression + XGBoost), expected loss & approval policy design | Python, XGBoost |

## 🛠️ Core Skills

- **Quant & Risk:** Monte Carlo methods, derivatives pricing, VaR/ES, stress testing (CCAR), liquidity risk (BCBS 248), ALM/IRR
- **AI/ML:** anomaly detection, gradient boosting, LLM multi-agent systems
- **Engineering:** Python (Pandas, NumPy, scikit-learn), SQL, Streamlit, Plotly

---

*All projects use synthetic or public data only.*
